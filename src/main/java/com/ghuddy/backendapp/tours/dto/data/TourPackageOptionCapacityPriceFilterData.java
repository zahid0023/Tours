...
@Getter
@Setter
public class TourPackageOptionCapacityPriceFilterData {
    ...
    public TourPackageOptionCapacityPriceFilterData(TourPackageOptionCapacityPriceFilterEntity entity) {
